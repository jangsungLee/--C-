...
namespace BIS_Big_Data__Yeosu__4.GetXMLClass.Attributes.BusOperationInfo_ClassMembers
{
    ...
    class _getStaionByRouteAll
    {
        ...
        public _getStaionByRouteAll(string BusOperationInfo_URL, string _ServiceKey)
        {
            _url = BusOperationInfo_URL + "getStaionByRouteAll" +
        ...
        static public class msgBody
        {
            ...
            static public string TOTASECL_T_DISTANCE = "TOTAL_SECT_DISTANCE";
        }
    }
}
